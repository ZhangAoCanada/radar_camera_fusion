...
int main(int argc, char* argv[]) {
    ...
    std::string in_filename = "/home/ao/1R1V/experiments/ukf_fusion_test/data/data-3.txt";
    std::string out_filename = "/home/ao/1R1V/experiments/ukf_fusion_test/data/out-3.txt";
    std::string config_filename = "/home/ao/1R1V/experiments/ukf_fusion_test/config.json";
